...
IF DB_ID('FormulaDb') IS  NULL
BEGIN
    /****** Object:  Database [FormulaDb]    Script Date: 2021. 11. 29. 22:32:35 ******/
CREATE  DATABASE [FormulaDb]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'FormulaDb', FILENAME = N'/var/opt/mssql/data/FormulaDb.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'FormulaDb_log', FILENAME = N'/var/opt/mssql/data/FormulaDb_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
END
...
ALTER DATABASE [FormulaDb] SET RECOVERY FULL 
GO
